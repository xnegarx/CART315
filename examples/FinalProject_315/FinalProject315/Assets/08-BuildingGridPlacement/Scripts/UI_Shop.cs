...
private void Start(){
   ...
   CreateItemButton(Item.ItemType.Chair, Item.GetSprite(Item.ItemType.Chair), "Chair", "upgrade rent to 20", Item.GetCost(Item.ItemType.Chair), 0);
       
   CreateItemButton(Item.ItemType.Table, Item.GetSprite(Item.ItemType.Table), "Table", "upgrade rent to 30", Item.GetCost(Item.ItemType.Table), 1);
   CreateItemButton(Item.ItemType.Bed, Item.GetSprite(Item.ItemType.Bed), "Bed", "upgrade rent to 40", Item.GetCost(Item.ItemType.Bed), 2);
